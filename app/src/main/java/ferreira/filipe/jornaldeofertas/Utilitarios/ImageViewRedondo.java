...
public class ImageViewRedondo extends android.support.v7.widget.AppCompatImageView{
    ...
    public ImageViewRedondo(Context context) {
        super(context);
    }

    public ImageViewRedondo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ImageViewRedondo(Context context, AttributeSet attrs, int defStyle) {
